  ...
  return (
    <div className="max-w-[1440px] mx-auto px-[90px] flex justify-between my-[68px]">
      <div className="flex 1 max-w-[610px]">
        ...
        <div className="w-[80%] ">
          <img src="./landingBanner3.png" alt="shopping pink clothes" className="min-h-full object-cover" />
        </div>
      </div>
      <div className="flex 1 max-w-[610px]">
        ...
        <div>
          <img src="./landingBanner4.png" alt="shopping poolside glam" className="min-h-full object-cover" />
        </div>
      </div>
    </div>
  );
