  ...
  return (
    <div className="max-w-[1440px] mx-auto px-[90px] flex justify-between mb-[68px]">
      <div className="flex 1 max-w-[610px]">
        ...
        <div className="w-[80%] ">
          <img src="./landingBanner1.png" alt="shopping red dress" className="min-h-full object-cover" />
        </div>
      </div>
      <div className="flex 1 max-w-[610px]">
        <div className="flex flex-col bg-[#1D5159] text-white font-[latoBold] px-5 py-[68px] max-w-[310px]">
          ...
          <p className="text-[28px] font-[latoRegular] mt-4 mb-[31px]">Get in gym essentials</p>
          <a href="#" className="font-[latoRegular] text-[20px] underline leading-9">Explore all category</a>
        </div>
        <div>
          <img src="./landingBanner2.png" alt="shopping gym essentials" className="min-h-full object-cover"/>
        </div>
      </div>
    </div>
  );
